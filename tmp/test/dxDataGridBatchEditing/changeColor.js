...
myApp.controller('defaultCtrl', ['$scope', function ($scope) {
    ...
    $scope.gridSettings = {
        ...
        onRowUpdated: function (e) {
            savedValues[e.key] = savedValues[e.key] || {};
            $.extend(savedValues[e.key], e.data);
            for (var dataField in e.data) {
                ...
                $cell[0].style.backgroundColor = '#90EE90';
                $cell[0].classList.add("waasaiii");
