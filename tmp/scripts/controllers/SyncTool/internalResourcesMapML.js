...
(function () {
    var tableName = "InternalResourcesMapML";
    //var currentResourceDispName = "";
    //var currentLangDispName = '';
    var resellerId;

    window.CmpTool.getAllInternalResourcesMapML = function (scope, parentResellerId) {
    ...
    function setDataSource(scope) {
        ...
        var syncData = function () {
            ...
            var syncTable = 'InternalResourcesMapML';
        ...
        var refreshGrid = function () {
            var getMethod = "GetInternalResourcesMapMLByResellerId";
            scope.getServiceData(tableName, getMethod, resellerId).then(function (respRefresh) {
                myGrid.columns = window.CmpTool.configInternalResourcesMapMLColumns(scope);
