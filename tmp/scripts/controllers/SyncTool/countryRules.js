...
(function () {
    var tableName = "CountryRules";

    window.CmpTool.getCountryRules = function (scope) {
    ...
    function setDataSource(scope) {
        ...
        var syncData = function () {
            ...
            var syncTable = 'CountryRules';
            var syncMethod = "SyncDataForCountryRulesTable";
        ...
        var refreshGrid = function () {
            var getMethod = "GetCountryRules";
            scope.getServiceData(tableName, getMethod).then(function(respRefresh) {
                myGrid.columns = window.CmpTool.configCountryRulesColumns(scope);
