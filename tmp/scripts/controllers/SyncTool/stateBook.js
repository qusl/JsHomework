...
(function () {
    var tableName = "StateBook";

    window.CmpTool.getStateBook = function (scope) {
    ...
    function setDataSource(scope) {
        ...
        var syncData = function () {
            ...
            var syncTable = 'StateBook';
            var syncMethod = "SyncDataForStateBookTable";
        ...
        var refreshGrid = function () {
            var getMethod = "GetStateBook";
            scope.getServiceData(tableName, getMethod).then(function(respRefresh) {
                myGrid.columns = window.CmpTool.configStateBookColumns(scope);
