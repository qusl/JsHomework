...
(function () {
    var tableName = "MeasurementUnit";

    window.CmpTool.getMeasurementUnit = function (scope) {
    ...
    function setDataSource(scope) {
        ...
        var syncData = function () {
            ...
            var syncTable = 'MeasurementUnit';
            var syncMethod = "SyncDataForMeasurementUnitTable";
        ...
        var refreshGrid = function () {
            var getMethod = "GetMeasurementUnit";
            scope.getServiceData(tableName, getMethod).then(function(respRefresh) {
                myGrid.columns = window.CmpTool.configMeasurementUnitColumns(scope);
