...
(function() {
    var tableName = "SecurityQuestions";

    window.CmpTool.getAllSecurityQuestions = function (scope) {
        setDataSource(scope);
    }
    ...
    function setDataSource(scope) {
        ...
        var refreshGrid = function () {
            var getMethod = "GetAllSecurityQuestions";
            scope.getServiceData(tableName, getMethod).then(function(respRefresh) {
                myGrid.columns = window.CmpTool.configSecurityQuestionsColumns(scope);
