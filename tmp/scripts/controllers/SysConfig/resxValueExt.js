...
(function () {
    var tableName = "ResxValueExt";
    var currentDetailDispName = '';
    var currentLangDispName = '';

    window.CmpTool.getAllResxValueExt = function (scope) {
    ...
    function setDataSource(scope) {
        ...
        var refreshGrid = function () {
            var getMethod = "GetAllResxValueExt";
            scope.getServiceData(tableName, getMethod).then(function(respRefresh) {
                myGrid.columns = window.CmpTool.configResxValueExtColumns(scope);
