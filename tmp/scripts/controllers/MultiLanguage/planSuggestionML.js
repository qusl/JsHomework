...
(function () {
    var tableName = "PlanSuggestionML";
    var currentPlanSrcDispName = '';
    var currentPlanDestDispName = '';
    var currentLangDispName = '';
    var resellerId;

    window.CmpTool.getPlanSuggestionML = function (scope, parentresellerId) {
    ...
    function setDataSource(scope) {
        ...
        var refreshGrid = function () {
            var getMethod = "GetPlanSuggestionMLByResellerId";
            scope.getServiceData(tableName, getMethod, resellerId).then(function (respRefresh) {
                myGrid.columns = window.CmpTool.configPlanSuggestionMLColumns(scope);
